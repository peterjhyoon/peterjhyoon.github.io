  ...
  return (
    <div className="flex h-[90vh] items-center bg-[linear-gradient(135deg,_#F5F9FF_0%,_#fff_100%)] relative overflow-hidden">
        <div className="container mx-auto px-30">
            ...
            <p className="pb-8 text-lg">Hi! I'm Peter, a senior at UC San Diego studying Mathematics and Computer Science.<br></br>
          I'm always passionate about learning something new to solve problems with data!
            </p>
